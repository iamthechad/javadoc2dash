...
public interface DocSetParserInterface {
     ...
     * @see IndexData
     */
    IndexData findIndexFile(File javadocDir) throws BuilderException;
     ...
     * @throws BuilderException in case of errors
     */
    List<SearchIndexValue> findSearchIndexValues(List<File> filesToIndex) throws BuilderException;
}
