...
[![codecov](https://codecov.io/gh/iamthechad/javadoc2dash/branch/master/graph/badge.svg)](https://codecov.io/gh/iamthechad/javadoc2dash)
...
Build script snippet for use in all Gradle versions:
    ...
    buildscript {
      ...
      dependencies {
        classpath "gradle.plugin.com.megatome.javadoc2dash:j2d-gradle:1.0.8"
      }
    }
...
Build script snippet for new, incubating, plugin mechanism introduced in Gradle 2.1:
    ...
    plugins {
      id "com.megatome.javadoc2dash" version "1.0.8"
    }
...
For Gradle:
    ...
    dependencies {
      compile "com.megatome.javadoc2dash:javadoc2dash-api:1.0.8"
    }
